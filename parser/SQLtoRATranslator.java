/* Generated By:JavaCC: Do not edit this line. SQLtoRATranslator.java */
...
public class SQLtoRATranslator implements SQLtoRATranslatorConstants {
  ...
  static final public PlanNode Select(Program p, String rangeVariable) throws ParseException {
    ...
    List<ExprTree> orList = null;
    List<ExprTree> lsIn=null;
    int ii=0;
  ...
  static final public List<ExprTree> OrderByList() throws ParseException {
    List<ExprTree> ret = new ArrayList<ExprTree>();
    ExprTree col;
    col = Expr();
                    ret.add(col);
  ...
  static final public Schema.Type TypeBase() throws ParseException {
    ...
    case TDATE:
      jj_consume_token(TDATE);
                       {if (true) return Schema.Type.DATE;}
      break;
    case TFLOAT:
  ...
  static public SQLtoRATranslatorTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x10000020,0x10000020,0x1800000,0x80,0x0,0x80,0x100,0x200,0x1000,0x800,0x2000,0x8000,0x4000,0x0,0x0,0x0,0x4000000,0x8000000,0x40,0x40,0x0,0x1b0000,0x1f0000,0x40,0x40,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc0000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x40,0x40,0x0,0x0,0x0,0x2000000,0x40,0x0,0x3b0001c,0x0,0x2000000,0xfff00,0xfff00,0xf00,0xc0000,0x3f000,0x20,0x3b0001c,0x3,};
   }

  /** Constructor with InputStream. */
  public SQLtoRATranslator(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public SQLtoRATranslator(java.io.InputStream stream, String encoding) {
    ...
    token_source = new SQLtoRATranslatorTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public SQLtoRATranslator(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public SQLtoRATranslator(SQLtoRATranslatorTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(SQLtoRATranslatorTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
